...
**Если на `https://weirdsar.github.io/sii5/` отдаётся 404 «There isn't a GitHub Pages site here»:** в **Settings → Pages** не выбран источник **GitHub Actions** — шаг **deploy** workflow падает. Выберите **Source: GitHub Actions**, затем **Actions → Deploy mafia to GitHub Pages → Re-run failed jobs** (или **Run workflow**).
