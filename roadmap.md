...
3. slug: "volgawhisper"
   ...
   shortDesc: "Сайт экскурсионного бюро с онлайн-бронированием и расписанием"
   ...
   solution: "Разработал атмосферный сайт с акцентом на визуал (фотографии Саратова и Волги). Создал страницы для каждой экскурсии с подробным описанием, фотогалереей и картой маршрута. Добавил расписание с возможностью онлайн-бронирования. Настроил адаптивный дизайн для удобного просмотра с телефона (основная аудитория — туристы в городе)."
   ...
   tags: ["Лендинг", "Бронирование", "Туризм"]
   image: "/images/cases/volgawhisper-preview.svg"
   gallery: []
